		...
		<PostsContext value={{ onDelete }}>
			<section className="posts">
				<div className="posts__container">
					...
					<ShowMoreButton currentPageNumber={currentPageNumber} totalPagesAmount={totalPagesAmount} onPageChange={onPageChange} />
